...
// Instance globale de Prisma (réutilisée entre les requêtes)
...
async function getStats() {
  ...
  const [totalListings, activeUsers, citiesResult, avgPriceResult] = await Promise.all([
  ...
  return {
    ...
    avgPrice: avgPriceResult._avg.price ? `${(avgPriceResult._avg.price / 1000000).toFixed(1)}M FCFA` : 'N/A'
  }
}
...
async function getRecentListings() {
  ...
  return listings.map(listing => ({
    id: listing.id,
    title: listing.title,
    price: `${(listing.price / 1000000).toFixed(1)}M FCFA`,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <nav className="space-x-4">
              ...
              <a href="/listings" className="text-gray-600 hover:text-blue-600">Annonces</a>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Plus de 500 annonces immobilières à Abidjan et dans toute la Côte d'Ivoire
          </p>
          <div className="flex justify-center space-x-4">
            <a href="/listings" className="bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100">
              Voir les annonces
            </a>
            <a href="/register" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600">
              Publier une annonce
            </a>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-600">{stats.cities}</div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h3 className="text-3xl font-bold text-center mb-12">Annonces récentes</h3>
            ...
            {recentListings.map((listing) => (
              <div key={listing.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-blue-600 mb-3">{listing.type}</p>
                  <div className="flex justify-between items-center">
                    <span className="text-2xl font-bold text-green-600">{listing.price}</span>
                    <a href={`/listings/${listing.id}`} className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
                      Voir détails
                    </a>
                  </div>
                </div>
          ...
          <div className="text-center mt-8">
            <a href="/listings" className="bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h4 className="text-lg font-semibold mb-4">🏠 Real Estate Portal</h4>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="/listings" className="hover:text-white">Annonces</a></li>
            ...
            <div>
              ...
              <p className="text-gray-400">
                📧 contact@realestate.ci<br/>
                📞 +225 01 02 03 04 05<br/>
                📍 Abidjan, Côte d'Ivoire
              </p>
            </div>
          </div>
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Real Estate Portal. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
    </div>
